...
namespace Org.OpenAPITools.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("http://localhost:8080/CFD/1.0.0");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://localhost:8080/CFD/1.0.0).
        /// </summary>
        ...
        public ApiClient(String basePath = "http://localhost:8080/CFD/1.0.0")
        {
